    ...
    try:
        ...
        for job in jobs_results:
            ...
            listing = JobListing(
                ...
                company=company,
                location=location,
                modality="remoto" if "remoto" in location.lower() or "remote" in location.lower() else "híbrido" if "híbrido" in location.lower() or "hybrid" in location.lower() else "presencial",
